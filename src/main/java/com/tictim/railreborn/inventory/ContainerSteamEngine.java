...
public class ContainerSteamEngine extends ContainerLogic<TileEntity>{
	public ContainerSteamEngine(TileEntity te, Logic logic, IInventory inventory, EntityPlayer player){
