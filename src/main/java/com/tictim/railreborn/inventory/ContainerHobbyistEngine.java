...
public class ContainerHobbyistEngine extends ContainerLogic<TileEntity>{
	public ContainerHobbyistEngine(TileEntity te, Logic logic, IInventory inventory, EntityPlayer player){
